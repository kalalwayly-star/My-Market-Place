import { auth, db, storage } from './firebase-config.js';  // Import Firebase Storage
...
// Finalize the ad and save it to Firestore
function finalizeAd() {
    ...
    const newAd = {
        ...
        condition: condition,
        image: uploadedImages.length ? uploadedImages : ["https://via.placeholder.com/300"], // Save image URLs
...
// Handle category change and form sections
